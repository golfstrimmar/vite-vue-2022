...
.container
  ...
  .page-block.blue-grey-4
    .page-title--small
      h2 Beispiele
    TabsTraining( title='' :SlotData='SlotDataInterrogativ' )
</template>
...
const SlotDataInterrogativ = [
  ...
  {
    t0: 'Какая  принадлежит Мануэле, большая или маленькая? (gehört Manuela große kleine)',
    t1: 'Welcher',
    t2: 'gehört',
    t3: 'Manuela',
    t4: ',',
  ...
  {
    t0: 'Рената выучила стихотворение. Что выучила Рената? (Renate Gedicht gelernt)',
    t1: 'Renate',
    t2: 'hat',
    t3: 'ein',
    t4: 'Gedicht',
  ...
  {
    t0: 'Его сестре принадлежит зеленая сумка. Какая сумка принадлежит его сестре? (Schwester gehört grüne Tasche )',
    t1: 'Seiner',
    t2: 'Schwester',
    t3: 'gehört',
    t4: 'die',
  ...
  {
    t0: 'Она действительно трижды подумала, кому подарить этот подарок на Рождество. (wirklich dreimal überlegt Geschenk zu Weihnachten geben)',
    t1: 'Sie',
    t2: 'hat',
    t3: 'sich',
    t4: 'wirklich',
  ...
  {
    t0: 'Без сомнения детективу с самого начала было ясно, чей это след. (Ohne Zweifel Detektiv Anfang an klar Fußabdruck)',
    t1: 'Ohne',
    t2: 'Zweifel',
    t3: 'war',
    t4: 'dem',
