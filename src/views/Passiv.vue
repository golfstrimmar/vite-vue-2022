...
.container
  ...
  Akkord(:titles="titles" :Data="[DVP, SVPräteritum, SVPerfekt,SVPlusquamperfekt,SVFuturum,Smüssen,SGegenwartPassiv,SVergangenheitPassiv,SFuturIPassiv,SFuturIIPassiv,SModalverbenGegenwartPassiv,SModalverbenVergangenheitPassiv,SModalverbenFuturIPassiv,SModalverbenFuturIIPassiv]"  @addTime ='addTime' :table="[TopVorPräsens,TopVorPräteritum,TopVorPerfekt,TopVorPlusquamperfekt,TopVorVorgangsFutur]" )
  ...
  //- Akkord(:titles="titlesZu" :Data="[SZustandspassivsPräsens,SZustandspassivsPräteritum,SZustandspassivsPerfekt,SZustandspassivsPlusquamperfekt,SZustandspassivsFuturum,SZuPräsensModalverb,SZuPräteritumModalverb,SZuPerfektModalverb,SZuPlusquamperfektModalverb,SZuFutur1Modalverb,SZuGegenwartPassiv,SZuVergangenheitPassiv,SZuFuturIPassiv,SZuFuturIIPassiv]"  @addTime ='addTime' )
