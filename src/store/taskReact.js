...
export default Timer;
      ...
      `,  description:'В этом примере useEffect используется для обновления счётчика времени каждую секунду.\n' +
...
export default App;
      `,  description:' это хук, который позволяет подключаться к контексту и ' +
...
export default Counter;
      ...
      `,  description:'это хук для управления более сложным состоянием, ' +
...
export default FocusInput;
      ...
      `,  description:'это хук, который позволяет хранить и ' +
...
export default App;
      ...
      `,  description:' это хук для оптимизации производительности. Он позволяет мемоизировать вычисления, ' +
...
export default LayoutEffectExample;
      ...
      `,  description:' useLayoutEffect — это хук, который работает аналогично useEffect, но с тем отличием,' +
...
export default Posts;
      `,  description:'Предположим, вам нужно часто делать запросы к API для получения данных в нескольких компонентах.' +
...
export default TodoApp;
      ...
      `,  description:'useLocalStorage — это кастомный хук, который сохраняет состояние в localStorage ' +
...
export default ResponsiveComponent;
      ...
      `,  description:'Пример 2: Хук для отслеживания ширины окна (useWindowWidth)\n' +
...
export default PostDetail;
      ...
      `,  description:'Одним из мощных механизмов React Router является поддержка динамических маршрутов. ' +
...
export default Login;
      ...
      `,  description:' Кроме навигации через <Link>, ' +
...
export default ProtectedRoute;
      ...
      `,  description:' <Navigate /> — компонент для программного перенаправления пользователя на другой маршрут.' +
...
export default App;
      `,  description:' Если пользователь пытается перейти на несуществующую страницу, важно отобразить страницу ошибки 404.' +
          ' Для этого можно использовать маршрут с path="*",' +
          ' который будет перехватывать все неизвестные пути.'},
      
    ],
    [{ title: "State Management" },
      {  dataText: ``,  description:'Локальное состояние (State) с использованием useState и useReducer'},
      {  dataText: `Redux
...
export default App;
      ...
      `,  description:' Redux/Мы создаём редьюсер для управления счётом.\n' +
...
export default App;
      ...
      `,  description:'Context API встроен в React и позволяет передавать данные через дерево компонентов без необходимости пропсами. ' +
...
export default App;
      ...
      `,  description:' Она позволяет разделять глобальное состояние на более мелкие атомы и использовать их в разных компонентах.' +
...
export default App;
      ...
      `,  description:'React.lazy позволяет динамически загружать компонент только тогда, когда он действительно нужен (например, когда пользователь переходит на соответствующую страницу). ' +
...
export default ParentComponent;
      ...
      `,  description:'Оптимизация ререндеринга с помощью React.memo и useMemo' +
...
export default ParentComponent;
      ...
      `,  description:'useMemo — это хук, который позволяет мемоизировать (запоминать) результат вычислений между рендерами, ' +
...
export default App;
      ...
      `,  description:'useEffect с пустым массивом зависимостей выполняет запрос при монтировании компонента.\n' +
...
export default App;
      ...
      `,  description:' axios.get выполняет GET-запрос, и результат доступен через response.data.\n' +
...
export default App;
      ...
      `,  description:' Когда мы выполняем асинхронные запросы в React, важно понимать, как управлять состоянием, когда компонент размонтирован, или когда запрос выполняется длительное время.\n' +
          '\n' +
...
export default MyComponent;
      ...
      `,  description:'В React с TypeScript компоненты могут быть типизированы как функциональные и классовые. ' +
...
export default MyComponent;
      ...
      `,  description:'Хотя FC удобен, его использование не обязательно. Вы можете типизировать компонент напрямую, используя тип props: '},
...
export default Counter;
      ...
      `,  description:'TypeScript позволяет задавать типы для состояния с помощью хука useState. ' +
...
`,  description:'Мы определяем интерфейс User, чтобы типизировать объект user, который хранит данные пользователя. В useState<User> передаем тип состояния как User. '},
...
export default Timer;
      ...
      `,  description:' TypeScript позволяет вам правильно типизировать хуки, такие как useEffect, useContext, useRef, и другие.\n' +
          '\n' +
          'Типизация useEffect\n' +
...
export default FocusInput;
`,  description:'useRef<HTMLInputElement>(null) — это правильная типизация для ссылки на DOM-элемент input. ' +
...
export default ClickButton;
      `,  description:' Когда вы работаете с событиями, такими как обработчики кликов или изменений, ' +
